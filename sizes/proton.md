...
Source: `idf.py size-components` in `proton/`. The two `.text` columns from the
tool are disambiguated below as `IRAM .text` (grouped under DIRAM, code executed
from RAM) and `Flash .text` (grouped under Flash Code, execute-in-place from
flash).

```
Executing "ninja size-components"...
[0/1] cd /workspaces/proton-communication-comparison/proton/build && /opt/esp/tools/cmake/4.0.3/bin/cmake -D "IDF_SIZE_TOOL=/opt/esp/python_env/idf6.0_py3.12_env/bin/python;-m;esp_idf_size" -D IDF_SIZE_MODE=--archives -D MAP_FILE=/workspaces/proton-communication-comparison/proton/build/esp32_proton_bench.map -D OUTPUT_JSON= -P /opt/esp/idf/tools/cmake/run_size_tool.cmake
```
...
| libtfpsacrypto.a | 117985 | 654 | 444 | 128 | 82 | 117331 | 0 | 4 | 16823 | 0 | 100504 | 0 | 0 |
| libpp.a | 111634 | 46746 | 2771 | 3201 | 40774 | 64888 | 0 | 0 | 8564 | 0 | 56324 | 0 | 0 |
| liblwip.a | 88430 | 2482 | 2470 | 12 | 0 | 85948 | 0 | 0 | 3226 | 0 | 82722 | 0 | 0 |
| libwpa_supplicant.a | 73609 | 1371 | 1363 | 8 | 0 | 72238 | 0 | 0 | 1660 | 0 | 70578 | 0 | 0 |
| libesp_stdio.a | 56723 | 16 | 16 | 0 | 0 | 56707 | 0 | 8 | 56275 | 0 | 424 | 0 | 0 |
| libphy.a | 31605 | 5751 | 44 | 951 | 4756 | 25854 | 0 | 0 | 0 | 0 | 25854 | 0 | 0 |
| libesp_hw_support.a | 29575 | 10442 | 96 | 1616 | 8730 | 19109 | 0 | 28 | 2359 | 0 | 16722 | 24 | 24 |
...
| libc.a | 14750 | 4 | 0 | 4 | 0 | 14746 | 0 | 0 | 1452 | 0 | 13294 | 0 | 0 |
| libnvs_flash.a | 14710 | 24 | 24 | 0 | 0 | 14686 | 0 | 0 | 136 | 0 | 14550 | 0 | 0 |
| libesp_system.a | 10246 | 1973 | 138 | 41 | 1794 | 8273 | 0 | 40 | 409 | 0 | 7824 | 0 | 0 |
| libesp_netif.a | 7730 | 193 | 189 | 4 | 0 | 7537 | 0 | 0 | 167 | 0 | 7370 | 0 | 0 |
| libcoexist.a | 6571 | 459 | 2 | 307 | 150 | 6112 | 0 | 0 | 1330 | 0 | 4782 | 0 | 0 |
| libesp_libc.a | 5236 | 3498 | 540 | 324 | 2634 | 1738 | 16 | 16 | 120 | 0 | 1586 | 0 | 0 |
| libesp_wifi.a | 4969 | 737 | 43 | 492 | 202 | 4232 | 0 | 4 | 790 | 0 | 3438 | 0 | 0 |
| libproton_core.a | 4724 | 0 | 0 | 0 | 0 | 4724 | 0 | 0 | 172 | 0 | 4552 | 0 | 0 |
...
| libesp_driver_dma.a | 2690 | 86 | 0 | 12 | 74 | 2604 | 0 | 0 | 102 | 0 | 2502 | 0 | 0 |
